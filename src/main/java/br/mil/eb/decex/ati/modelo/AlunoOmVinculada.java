...
/**
 * Base para lançamento das Organizações Militares Vinculadas.
 * 
...
@Entity
@NamedQueries({
    @NamedQuery(name="alunoOmVinculada.listarPorOMEPeriodo",
                query="SELECT o FROM AlunoOmVinculada o WHERE periodo = :periodo AND organizacaoMilitar = :organizacao"),
})
@Table(name="alunoOmVinculada" , uniqueConstraints={@UniqueConstraint(columnNames={"periodo_id", "tipoalunoomvinculada", "organizacao_id"})})
 
public class AlunoOmVinculada extends BaseModel<Long> implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="OMVINCULADA_ID_GENERATOR", sequenceName="OMVINCULADA_ID_SEQ", allocationSize=1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="OMVINCULADA_ID_GENERATOR")	
	private Long id;
	...
	private TipoAlunoOmVinculada tipoAlunoOmVinculada;
	...
	/**
	 * Carrega a forca com valores do Enum tipoAlunoOmVinculada
	 * @see br.mil.eb.decex.ati.enumerado.TipoAlunoOmVinculada
	 * @returnf TipoAlunoOmVinculada
	 */
	public TipoAlunoOmVinculada getTipoAlunoOmVinculada() {
		return tipoAlunoOmVinculada;
	}
	public void setTipoAlunoOmVinculada(TipoAlunoOmVinculada tipoAlunoOmVinculada) {
		this.tipoAlunoOmVinculada = tipoAlunoOmVinculada;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!super.equals(obj))
			return false;
		if (!(obj instanceof AlunoOmVinculada))
			return false;
		AlunoOmVinculada other = (AlunoOmVinculada) obj;
	...
	public String toString() {
		return "AlunoOmVinculada [id=" + id + ", periodo=" + periodo + ", organizacaoMilitar=" + organizacaoMilitar
				+ ", tipoAlunoOmVinculada=" + tipoAlunoOmVinculada + ", masculino=" + masculino + ", feminino="
				+ feminino + "]";
	}
